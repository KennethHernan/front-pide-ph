...
const TableNatural = ({ dataNatural }) => {
  ...
  return (
    <div className="overflow-x-auto">
      <table className="text-sm min-w-full rounded-md shadow-lg">
        <thead className="bg-slate-200">
          <tr>
            <th className="px-6 py-3 text-xl">#</th>
            <th className="px-6 py-3">Registro</th>
            <th className="px-6 py-3">Libro</th>
            <th className="px-6 py-3">Paterno</th>
            <th className="px-6 py-3">Materno</th>
            <th className="px-6 py-3">Nombres</th>
            <th className="px-6 py-3">Partida</th>
            <th className="px6 py-3">Nº Placa</th>
        ...
        <tbody className="bg-slate-100">
          {dataNatural.map((elemento, index) => (
            <tr className="border" key={uuidv4()}>
              <td className="px-6 py-4">{index + 1}</td>
              <td className="px-6 py-4">{elemento.registro}</td>
              <td className="px-6 py-4">{elemento.libro}</td>
              <td className="px-6 py-4">{elemento.apPaterno}</td>
              <td className="px-6 py-4">{elemento.apMaterno}</td>
